 ...
 * @author Auto-generated by schemagen on 30 Apr 2011 11:22 
 */
public class DeliSchema {
    ...
    /** <p>Why the profile was invalid</p> */
    public static final Property validatorOutput = m_model.createProperty( "http://delicon.sourceforge.net/schema#validatorOutput" );
    
    /** <p>The result of the validator</p> */
    public static final Property validatorResult = m_model.createProperty( "http://delicon.sourceforge.net/schema#validatorResult" );
    
    /** <p>Invalid</p> */
    public static final Resource Invalid = m_model.createResource( "http://delicon.sourceforge.net/schema#Invalid" );
    ...
    /** <p>Unretrievable</p> */
    public static final Resource Unretrievable = m_model.createResource( "http://delicon.sourceforge.net/schema#Unretrievable" );
    
    /** <p>Valid profile</p> */
    public static final Resource Valid = m_model.createResource( "http://delicon.sourceforge.net/schema#Valid" );
